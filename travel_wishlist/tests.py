...
class TestHomePage(TestCase):
    ...
    def test_home_page_shows_empty_list_message_for_empty_database(self):
        ...
        self.asseryTemplateListed(response,'travel_wishlist/wishlist.html')
...
class TestVisitedPage(TestCase):
    ...
    def test_home_page_shows_empty_list_message_for_empty_database(self):
        ...
        self.asseryTemplateUsed(response,'travel_wishlist/visited.html')
        self.assertContains(response, 'You have no visited any places yet.')
...
class TestAddNewPlace(TestCase):
    ...
    def test_add_new_unvisited_place(self):
        ...
        self.assertEqual(1, len(response_places)) # chack only one place
...
class TestVisitedPlace(TestCase):
    ...
    def test_visit_place(self):
        ...
        self.assertTemplateUsed(response,'New York')
        self.assertContains(response, 'Tokyo')
        ...
        def test_non_existent_place(self):
            visited_nonexistent_place_url = reverse('place_was_visited', args=(123456, ))
            response = self.client.post(visited_nonexistent_place_url, folloe=True)
